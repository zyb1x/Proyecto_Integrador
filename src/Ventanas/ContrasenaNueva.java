 ...
 * @author Pablo
 */
public class ContrasenaNueva extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(10, 54, 86));
   ...
   // Crear instancia del formulario de recuperación
    login l = new login();
    
    // Configurar la nueva ventana
    l.setLocationRelativeTo(null); // Centrar en pantalla
    l.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContrasenaNueva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContrasenaNueva().setVisible(true);
            }
        });
    }
